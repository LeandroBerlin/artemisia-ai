        ...
        <footer className="mt-6 bg-white p-4  p-8 antialiased">
            ...
            <span className="flex justify-center m-4 text-sm text-center text-gray-500 dark:text-gray-400 mb-0">
                ...
                <Link href="https://vercel.com">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000" height="20pt">
                        <g>
                ...
                <Link href="https://replicate.com">
                    <svg className="mx-1 inline-block" height="40pt" viewBox=".5 -.2 1023 1024.1" width="40pt" xmlns="http://www.w3.org/2000/svg">
